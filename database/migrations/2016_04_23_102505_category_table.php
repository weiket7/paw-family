...
class CategoryTable extends Migration
{
    public function up()
    {
      ...
      DB::table('category')->insert([
        'category_id'=>7, 'main_category'=>MainCategory::Cats, 'name'=>'Dry Food', 'pos'=>1,
        'updated_by'=>'ruth', 'updated_at'=>date('Y-m-d H:is'
        )]);
      DB::table('category')->insert([
        'category_id'=>8, 'main_category'=>MainCategory::Cats, 'name'=>'Canned Food', 'pos'=>2,
        'updated_by'=>'ruth', 'updated_at'=>date('Y-m-d H:is'
        )]);
      DB::table('category')->insert([
        'category_id'=>9, 'main_category'=>MainCategory::Cats, 'name'=>'Supplements', 'pos'=>3,
        'updated_by'=>'ruth', 'updated_at'=>date('Y-m-d H:is')
      ]);
      DB::table('category')->insert([
        'category_id'=>10, 'main_category'=>MainCategory::Cats, 'name'=>'Treats', 'pos'=>4,
        'updated_by'=>'ruth', 'updated_at'=>date('Y-m-d H:is')
      ]);
      DB::table('category')->insert([
        'category_id'=>11, 'main_category'=>MainCategory::Cats, 'name'=>'Grooming', 'pos'=>5,
        'updated_by'=>'ruth', 'updated_at'=>date('Y-m-d H:is')
      ]);
      DB::table('category')->insert([
        'category_id'=>12, 'main_category'=>MainCategory::Cats, 'name'=>'Acessories', 'pos'=>6,
        'updated_by'=>'ruth', 'updated_at'=>date('Y-m-d H:is')
      ]);
      DB::table('category')->insert([
        'category_id'=>13, 'main_category'=>MainCategory::Cats, 'name'=>'Cat Litter', 'pos'=>'7',
        'updated_by'=>'ruth', 'updated_at'=>date('Y-m-d H:is'
      )]);
