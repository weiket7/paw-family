...
class CategoryTable extends Migration
{
    public function up()
    {
      ...
      DB::table('category')->insert([
        ...
        'pos'=>'7', 'updated_by'=>'ruth', 'updated_on'=>date('Y-m-d H:i:s'
      )]);
