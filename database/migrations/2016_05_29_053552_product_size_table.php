...
class ProductSizeTable extends Migration
{
  public function up()
  {
    ...
    DB::table('product_size')->insert([
      'size_id'=>1, 'product_id'=>1, 'name'=>'Small', 'quantity'=>5, 'weight_lb'=>4, 'cost_price'=>24.1, 'price'=>39.1,
      'discount_amt'=>10, 'discount_type'=>'A', 'discounted_price'=>29.1,
      'updated_by'=>'ruth', 'updated_on'=>date('Y-m-d H:i:s')
    ]);
    DB::table('product_size')->insert([
      'size_id'=>2, 'product_id'=>1, 'name'=>'Medium', 'quantity'=>10, 'weight_lb'=>20, 'cost_price'=>126.9, 'price'=>142.9,
      'discount_amt'=>10, 'discount_type'=>'A', 'discounted_price'=>132.9,
      'updated_by'=>'ruth', 'updated_on'=>date('Y-m-d H:i:s')
    ]);
    DB::table('product_size')->insert([
      'size_id'=>3, 'product_id'=>1, 'name'=>'Large', 'quantity'=>0, 'weight_lb'=>33, 'cost_price'=>170, 'price'=>195.55,
