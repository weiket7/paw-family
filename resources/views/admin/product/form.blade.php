  ...
  <script type="text/javascript">
    $("#btn-calculate").click(function() {
      ...
      if (discount_percentage == 0) {
        ...
        discount_amt = price / 100 * discount_percentage;
        $("input[name='discount_amt']").val(toTwoDecimal(discount_amt));
        discounted_price = price - discount_amt;
      }
      $("input[name='discounted_price']").val(toTwoDecimal(discounted_price));
