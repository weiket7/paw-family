            ...
            <tr>
              ...
              <td>
                <div class="clearfix quantity r_corners d_inline_middle f_size_medium color_dark m_bottom_10">
                  ...
                  <input type="text" name="" readonly value="{{$p->quantity}}" class="f_left">
              ...
              <td>
                ...
                ${{CommonHelper::formatNumber($p->price * $p->quantity)}}</td>
            </tr>
          @endforeach
          <tr>
            <td colspan="3">
              <p class="fw_medium f_size_large t_align_r t_xs_align_c">Promo Discount:</p>
            </td>
            <td colspan="1">
