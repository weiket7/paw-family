  ...
  <div class="row clearfix">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 t_xs_align_c s_banners">
      <a href="#" class="d_block d_xs_inline_b m_bottom_20 animate_ftr">
        <img src="{{url("assets/images/banners/".$banners[6]->image)}}" alt="">
      </a>
      <a href="#" class="d_block d_xs_inline_b m_xs_left_5 animate_ftr m_mxs_left_0">
        <img src="{{url("assets/images/banners/".$banners[7]->image)}}" alt="">
      </a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <section class="row clearfix">
      <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_sm_bottom_35">
        <a href="{{$banners[8]->link}}" class="d_block banner animate_ftr wrapper r_corners relative m_xs_bottom_30">
          <img src="{{url("assets/images/banners/".$banners[8]->image)}}" alt="">
        </a>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 m_bottom_50 m_sm_bottom_35">
        <a href="{{$banners[9]->link}}" class="d_block banner animate_ftr wrapper r_corners relative m_xs_bottom_30">
          <img src="{{url("assets/images/banners/".$banners[9]->image)}}" alt="">
        </a>
      </div>
    </section>
    <div class="row clearfix">
